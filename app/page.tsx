      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-8 lg:px-16">
          <div className="max-w-2xl space-y-8">
            ...
            {/* Headline */}
            <h1 className="font-serif mt-50 text-6xl font-bold bg-gradient-to-r from-white via-gray-300 to-blue-400 bg-[length:200%_200%] animate-gradient bg-clip-text text-transparent">
...
<section className="py-24 bg-gray-50">
  <div className="max-w-7xl mx-auto px-8">
    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mt-16">
      ...
      <ReviewCard
        name="Priya Shah"
        review="The clinic is extremely clean and modern. Dr. Kartik Patel explained everything clearly and the treatment was painless."
      />

      <ReviewCard
        name="Rahul Mehta"
        review="Best dental experience in Surat. Very friendly staff and excellent orthodontic treatment. Highly recommended!"
      />

      <ReviewCard
        name="Sneha Patel"
        review="I was nervous at first, but the doctor made me feel comfortable. Amazing service and great results."
      />
...
<section className="py-24 bg-white">
  <div className="max-w-7xl mx-auto px-8 grid lg:grid-cols-2 gap-14 items-center">
    ...
    <div className="space-y-6">
      ...
      <p className="text-gray-500 text-lg leading-relaxed">
        Enjoy modern dental care in a truly welcoming and easily accessible environment at 7th Heaven Family Dentistry.
      </p>
...
<section className="py-24 bg-gray-50">
  ...
  Answers to Your Common Concerns
      ...
      <p className="text-gray-500 text-lg leading-relaxed">
        Everything you need to know before visiting 7th Heaven Dentistry.
      </p>
    </div>
    ...
    <div className="mt-14 grid md:grid-cols-2 gap-6">
      ...
      <FAQItem
        ...
        answer="We are open Monday to Saturday, from 10AM–1PM and 4PM–8PM. The clinic remains closed on Sundays."
      />
